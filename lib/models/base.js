...
BaseModel.prototype.__non_editable = [];
...
/*
 *
 * The stub method is used for returning a smaller amount of data, it should be overridden in custom models to output needed information.
 *
 * @method stub
 * @returns {Object}
 *
